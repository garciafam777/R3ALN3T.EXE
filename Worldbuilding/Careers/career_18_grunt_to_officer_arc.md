# Career: Grunt-to-Officer Arc

**Career ID:** 18
**Element affinity:** Fire (canonical wheel: Fire > Aqua > Elec > Wood > Wind > Holy > Void > Fire)
**World tie-in:** Generic progression template usable across ASTRUM DIVISION (→ Aegis Concord) and any martial faction.
**Anchor faction/region:** ASTRUM DIVISION (→ Aegis Concord)
**Status:** ✅ CANON — CEO-approved (promoted from DRAFT, 2026-07-10)

## Overview
Grunt-to-Officer Arc is a Fire-element career path rooted in the ASTRUM DIVISION (→ Aegis Concord) sphere of the R3ALN3T.EXE world (year 3026).
