...
**World tie-in:** Border-conflict macro-region — ASTRUM DIVISION holds the Abyssal Plains frontier against CORRUPTED SECTOR incursions.
**Anchor faction/region:** ASTRUM DIVISION
**Status:** ✅ CANON — CEO-approved (promoted from DRAFT, 2026-07-10)

## Overview
Frontline Infantry is a Fire-element career path rooted in the ASTRUM DIVISION sphere of the R3ALN3T.EXE world (year 3026).
It exists as world texture and player progression flavor; it makes no claims about dominion-tier lore.

## Role in the World
- Operates within: ASTRUM DIVISION
...
- Mid: trained operator within ASTRUM DIVISION.
