# Career: Wood Nature Warden

**Career ID:** 13
**Element affinity:** Wood (canonical wheel: Fire > Aqua > Elec > Wood > Wind > Holy > Void > Fire)
**World tie-in:** Forested macro-region — PHAGE CELL's cultivators tending the petrified coral forests.
**Anchor faction/region:** PHAGE CELL
**Status:** ✅ CANON — CEO-approved (promoted from DRAFT, 2026-07-10)

## Overview
Wood Nature Warden is a Wood-element career path rooted in the PHAGE CELL sphere of the R3ALN3T.EXE world (year 3026).
