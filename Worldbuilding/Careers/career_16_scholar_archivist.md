# Career: Scholar-Archivist

**Career ID:** 16
**Element affinity:** Elec (canonical wheel: Fire > Aqua > Elec > Wood > Wind > Holy > Void > Fire)
**World tie-in:** Library-fortress — GEAR SECT (→ N3T Dominion)'s lore-keepers; ties to the Obsidian story-engine.
**Anchor faction/region:** GEAR SECT (→ N3T Dominion)
**Status:** ✅ CANON — CEO-approved (promoted from DRAFT, 2026-07-10)

## Overview
Scholar-Archivist is a Elec-element career path rooted in the GEAR SECT (→ N3T Dominion) sphere of the R3ALN3T.EXE world (year 3026).
