...
**World tie-in:** Data-fortress city — GEAR SECT (→ N3T Dominion)'s keepers of the core routing lattices.
**Anchor faction/region:** GEAR SECT (→ N3T Dominion)
**Status:** ✅ CANON — CEO-approved (promoted from DRAFT, 2026-07-10)

## Overview
Systems Administrator is a Elec-element career path rooted in the GEAR SECT (→ N3T Dominion) sphere of the R3ALN3T.EXE world (year 3026).
