# Career: Civilian-to-Awakened Arc

**Career ID:** 19
**Element affinity:** Wood (canonical wheel: Fire > Aqua > Elec > Wood > Wind > Holy > Void > Fire)
**World tie-in:** Onboarding story — how a normal person gains an element affinity (Wood, the gentlest awakening).
**Anchor faction/region:** PHAGE CELL (→ Free Grid Collective)
**Status:** ✅ CANON — CEO-approved (promoted from DRAFT, 2026-07-10)

## Overview
Civilian-to-Awakened Arc is a Wood-element career path rooted in the PHAGE CELL (→ Free Grid Collective) sphere of the R3ALN3T.EXE world (year 3026).
It exists as world texture and player progression flavor; it makes no claims about dominion-tier lore.

## Role in the World
- Operates within: PHAGE CELL (→ Free Grid Collective)
- Geographic home: one of the post-Fall regions (Abyssal Plains, Sky-Spine Range, Trench Basins)
- Element consistency: Wood is valid under the canonical wheel and does not break combat balance assumptions.

## Progression Sketch
- Entry: civilian or recruit with latent Wood affinity.
- Mid: trained operator within PHAGE CELL (→ Free Grid Collective).
