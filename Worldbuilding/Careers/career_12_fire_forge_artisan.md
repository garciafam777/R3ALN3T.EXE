# Career: Fire-forge Artisan

**Career ID:** 12
**Element affinity:** Fire (canonical wheel: Fire > Aqua > Elec > Wood > Wind > Holy > Void > Fire)
**World tie-in:** Volcanic industrial region — ROT CLUSTER's forge-smiths of the demonic forges.
**Anchor faction/region:** ROT CLUSTER
**Status:** ✅ CANON — CEO-approved (promoted from DRAFT, 2026-07-10)

## Overview
Fire-forge Artisan is a Fire-element career path rooted in the ROT CLUSTER sphere of the R3ALN3T.EXE world (year 3026).
It exists as world texture and player progression flavor; it makes no claims about dominion-tier lore.

## Role in the World
- Operates within: ROT CLUSTER
...
- Mid: trained operator within ROT CLUSTER.
