# Career: Network Defender (ISSO-analog)

**Career ID:** 06
**Element affinity:** Elec (canonical wheel: Fire > Aqua > Elec > Wood > Wind > Holy > Void > Fire)
**World tie-in:** Undernet region — GEAR SECT (→ N3T Dominion)'s firewall-monks guarding the data-fortress substrate.
**Anchor faction/region:** GEAR SECT (→ N3T Dominion)
**Status:** ✅ CANON — CEO-approved (promoted from DRAFT, 2026-07-10)

## Overview
Network Defender (ISSO-analog) is a Elec-element career path rooted in the GEAR SECT (→ N3T Dominion) sphere of the R3ALN3T.EXE world (year 3026).
It exists as world texture and player progression flavor; it makes no claims about dominion-tier lore.

## Role in the World
- Operates within: GEAR SECT (→ N3T Dominion)
...
- Mid: trained operator within GEAR SECT (→ N3T Dominion).
