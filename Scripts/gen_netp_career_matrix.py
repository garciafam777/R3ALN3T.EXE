...
CAT_ARCH = {
    "transportation_logistics": ("Trucker", "Cyber Belly Unit"),
    "space_operations": ("ATC", "Runway Control Sphere"),
    "medical_biosystem": ("Medical", "Medi-Synth Shell"),
    "construction": ("Construction", "Dump-Transformer Hull"),
    "cybersecurity": ("Cipher", "Shielded Cipher Exoshell"),
    "artificial_intelligence": ("Cognition", "Cognition Rig"),
    "information_technology": ("DataCenter", "Data Center Frame"),
    "manufacturing": ("Factory", "Factory-Bot Shell"),
    "science_research": ("Lab", "Lab Astral Rig"),
    "government_administration": ("Civic", "Civic Command Shell"),
    "military_defense": ("Orbital", "Orbital Enforcer Exo"),
}
CAT_FACTION = {
    "transportation_logistics": "EON LOGISTICS", "space_operations": "SKY DIRECTORATE",
    "medical_biosystem": "CLINIC ORDER", "construction": "INFRA DOMINION", "cybersecurity": "CIPHER COLLECTIVE",
    "artificial_intelligence": "COGNITION GUILD", "information_technology": "DATA SOVEREIGN",
    "manufacturing": "FORGE SYNDICATE", "science_research": "ASTRA LAB", "government_administration": "CIVIC CORE",
    "military_defense": "ORBITAL ENCLAVE", "agriculture_biosphere": "BIOSPHERE ORDER", "communications_media": "SIGNAL CHOIR",
    "economics_trade": "LEDGER CONSORTIUM", "education": "SCHOLA NET", "engineering": "STRUCTURE PACT",
    "entertainment_arts": "LUMEN STAGE", "exploration": "FRONTIER GUILD", "intelligence_agencies": "NULL WATCH",
    "law_justice": "JUSTITIA RING",
}
